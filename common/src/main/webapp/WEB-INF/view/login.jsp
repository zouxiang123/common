...
<body style="padding-top: 0px;">
    <div class="p-t-20 p-b-21 p-l-42 p-r-20 bg-rgba-black f-w-100" style="height: 100px; position: absolute;">
        ...
        <div class="pull-right" style="line-height: 60px;">
            <a class="fc-white u-a-none" href="${ctx }/about.shtml">关于我们</a> <a class="fc-white m-l-28 u-a-none" href="${ctx }/feedback.shtml">意见反馈</a>
        </div>
    </div>
    <div class="u-bg-img">
        <div class="u-logo-zs">
            <div class="f-m-auto f-w-300">
                ...
                <form role="form-signin" action="${ctx }/login.shtml" onsubmit="return validate();" method="post" id="loginForm">
                    ...
                    <div class="fs-18 m-t-43 u-lst-50">
                        <input placeholder="请输入您的账号" id="account" name="account" value="${account }" class="u-input-none placeholder" type="text"
                            onFocus="if(value==''){this.style.color='#000';this.placeholder='';}"
                            onBlur="if(value==''){this.style.color='#999';this.placeholder='请输入您的账号';}" />
                    </div>
                    <div class="fs-18 m-t-12 u-lst-50">
                        <input placeholder="请输入您的密码" id="password" name="password" value="${password }" class="u-input-none placeholder"
                            type="password" onFocus="if(value==''){this.style.color='#000';this.placeholder='';}"
                            onBlur="if(value==''){this.style.color='#999';this.placeholder='请输入您的密码';}" />
                    </div>
                    <div class="m-t-40 fc-grey">
                        <label for="savePassword"> <input id="savePassword" class="u-checkbox f-checkbox" type="checkbox" name="savePassword">
                            十天内免登录
                        </label>
                    </div>
        ...
        <div class="text-center f-p-absolute fc-white f-opa8 f-w-100" style="bottom: 20px;">
            ...
            <p class="fs-12">
                学透通医疗科技（上海）有限公司 版权所有 2015-<span id="year"></span>
            </p>
        </div>
    </div>
