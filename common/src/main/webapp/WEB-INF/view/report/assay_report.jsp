...
<body style="overflow-x:hidden">
    ...
    <div class="xtt">
                ...
                <form id="selectForm" action="#" style="display: none;">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="bb-dashed pb-10 u-display-inlineBlock width-280">
                            <label class="u-select w-100"> <select style="width:282px" name="groupId" id="groupId" onchange="changeGroupId()"></select>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="bb-dashed pb-10 u-display-inlineBlock width-280">
                            <label class="u-select w-100"> <select style="width:282px" name="itemCode" id="itemCode" onchange="changeItemCode()"></select>
                            </label>
                        </div>
                    </div>
                    <div class="mb-10">
        ...
        <div id="contentDiv">
            <div>
                <div class="echartshalf" style="margin-top:0px">
                    <label class="u-checkbox echartsave" style= "right:140px;top:14px"> <input type="checkbox" name="echarts1" id="shownum" checked> <span
                        class="icon-checkbox"></span>显示数据
                    </label>
                    <div id="dbbarChart" class="u-clearfix w-100 u-display-block" style="height:300px;"></div>
                </div>

                <div class="echartshalf">
                    <label class="u-checkbox echartsave" style= "right:140px;top:14px"> <input type="checkbox" name="echarts2" id="shownum2" checked> <span
                        class="icon-checkbox"></span> 显示数据
                    </label>
                    <div id="zwsLineChart" class="u-clearfix w-100 u-display-block" style="height:300px;"></div>
                </div>

                <div class="echartshalf">
                    <label class="u-checkbox echartsave" style= "right:60px;top:14px"> <input type="checkbox" name="echarts3" id="shownum3" checked> <span
                        class="icon-checkbox"></span> 显示数据
                    </label>
                    <div id="chart2" class="u-clearfix w-100 u-display-block" style="height:300px;"></div>
                </div>

                <div class="ml-22 mt-10 mb-10">化验项列表</div>
            ...
            <div style="display: none">
                <div class="echartshalf" style="margin-top:0px">
                    <!-- <span class="position-relative" style="top: 24px; left: 2px">达标统计 </span>  -->
                    <label class="u-checkbox echartsave" style= "right:70px;top:12px"> 
                    <input type="checkbox" name="echarts4" id="shownum4" checked> <span
                        class="icon-checkbox"></span>显示数据
                    </label>
                    <div id="monthSeasonOkPie" class="u-clearfix w-100 u-display-block" style="height:260px;"></div>
                </div>
                ...
                <div id="grouped" style="display: none">
                    <div class="echartshalf">
                        ...
                        <label class="u-checkbox echartsave" style= "right:70px;top:12px">
                        <input type="checkbox" name="echarts5" id="shownum5" checked> <span
                            class="icon-checkbox"></span>显示数据
                        </label>
                        <div id="groupPie" class="u-clearfix w-100 u-display-block" style="height:260px;"></div>
                    </div>
                    <div class="ml-12 mr-12 mt-10">
                        <table class="u-table u-table-bordered">
                            <thead>
