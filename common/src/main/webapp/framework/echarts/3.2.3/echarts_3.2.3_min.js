!function (t, e) {
    ...
    return function (t) {
        ...
        function r(t, e, i, r) {
            var o = ((t || "") + "").split("\n").length, a = n(t, e), s = n("å›½", e), l = o * s, u = new d(0, 0, a, l);
        ...
        function a(t, e, i, r, o) {
            if (!e)return "";
            o = o || {}, r = f(r, "...");
            for (var a = f(o.maxIterations, 2), l = f(o.minChar, 0), u = n("å›½", i), h = n("a", i), c = f(o.placeholder, ""), d = e = Math.max(0, e - 1), p = 0; l > p && d >= h; p++)d -= h;
            var g = n(r);
            g > d && (r = "", g = 0), d = e - g;
