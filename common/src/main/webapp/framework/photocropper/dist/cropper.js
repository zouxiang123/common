  ...
  $.extend(prototype, {
    ...
    limitCropBox: function (size, position) {
      ...
      if (size) {
        ...
        cropBoxWidth = num(options.cropBoxWidth) || 0;
        cropBoxHeight = num(options.cropBoxHeight) || 0;
        ...
        cropBox.width = max(cropBox.minWidth, cropBoxWidth);
        cropBox.height = max(cropBox.minHeight, cropBoxHeight);
