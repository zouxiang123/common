...
(function() {
    ...
    function setPanelStyle() {
        ...
        $(l.container).style.left = "0px";
        $(l.container).style.top = q.offsetParent.offsetTop - q.offsetParent.offsetHeight - 194 + "px";
    ...
    function getPageViewContentHtml(a, b) {
        ...
        for (var i = a; i < b; i++) {
            if (u[i]) {
                ...
                e = u[i][p['hz']],
                f = u[i][p['py']],
                g = '<span class=' + m.title + '>' + e + '</span><span style="display:none;">' + f + '</span>';
