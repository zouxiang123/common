...
public class PatientAssayRecordServiceImpl implements IPatientAssayRecordService {
	...
	@Override
	public List<Map<String, Object>> selectLatestAssayDateByTenantId(Integer tenantId) {
		return patientAssayRecordMapper.selectLatestAssayDateByTenantId(tenantId);
	}
