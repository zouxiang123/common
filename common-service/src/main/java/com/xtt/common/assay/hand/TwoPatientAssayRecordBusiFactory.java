...
@Service
public class TwoPatientAssayRecordBusiFactory extends AbstractPatientAssayRecordBusi {

    private static final Logger log = LoggerFactory.getLogger(TwoPatientAssayRecordBusiFactory.class);
