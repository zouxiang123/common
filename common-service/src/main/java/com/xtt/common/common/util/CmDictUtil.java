...
import com.xtt.common.common.cache.CmDictByMemory;
import com.xtt.common.common.cache.ICmDictFactory;
import com.xtt.common.dao.po.CmDictPO;
import com.xtt.platform.util.lang.StringUtil;

public class CmDictUtil {

	private static ICmDictFactory factory = new CmDictByMemory();
	 ...
	 * 
	 */
	public static List<CmDictPO> getListByType(String type) {
	...
	public static Map<String, String> getNamesByType(String type) {
		...
		for (CmDictPO dp : factory.getListByType(type)) {
			map.put(dp.getItemCode(), dp.getItemName());
		}
		return map;
	}

	private static List<CmDictPO> getListByType(String type, String selectStr, boolean isBool) {
		List<CmDictPO> list = getListByType(type);
	 ...
	 * 
	 */
	public static List<CmDictPO> getListByType(String type, String selectStr) {
	 ...
	 * 
	 */
	public static List<CmDictPO> getListByType(String type, Boolean selected) {
		String selectStr = "";
