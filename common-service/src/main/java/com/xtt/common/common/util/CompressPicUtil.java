...
public class CompressPicUtil {
	...
	public static void main(String[] arg) {
		...
		System.out.println("输入的图片大小：" + mypic.getPicSize("C:\\temp\\65.png") / 1024 + "KB");
		mypic.compressPic("C:\\temp\\", "c:\\temp\\", "65.png", "65.png", 144, 144, true);
		System.out.println("输出的图片大小：" + mypic.getPicSize("C:\\temp\\65.png") / 1024 + "KB");
		...
		// System.out.println("输出的图片大小：" + mypic.getPicSize("e:\\test\\r1" + i +
		// ".jpg") / 1024 + "KB");
		// }
