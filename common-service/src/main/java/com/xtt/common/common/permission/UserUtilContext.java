...
public class UserUtilContext {
	...
	public static void setPermission(Long[] roleIds) {
		if (roleIds == null) {
			...
			ContextAuthUtil.putAuth(CommonConstants.USER_PERMISSION, covertSysObjList(PermissionUtil.getPermissionList(roleIds)));
		}
	}
	...
	public static void setNonPermissionList(Long[] roleIds) {
		if (roleIds == null) {
			...
			ContextAuthUtil.putAuth(CommonConstants.USER_NON_PERMISSION, covertSysObjList(PermissionUtil.getNonPermissionList(roleIds)));
		}
	}
	...
	public static void setApiPermissionList(Long[] roleIds) {
		if (roleIds == null) {
			...
			ContextAuthUtil.putAuth(CommonConstants.API_PERMISSION, covertSysObjList(PermissionUtil.getApiPermissionList(roleIds)));
		}
	}
	...
	private static String covertSysObjList(List<SysObj> list) {
