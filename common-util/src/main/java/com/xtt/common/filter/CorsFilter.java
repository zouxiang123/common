 ...
 * </p>
 * <ul>
 * <li><b>cors.isCorsRequest:</b> Flag to determine if the request is a CORS request. Set to <code>true</code> if a CORS request; <code>false</code>
 * otherwise.</li>
...
public final class CorsFilter implements Filter {
    ...
    protected void handleSimpleCORS(final HttpServletRequest request, final HttpServletResponse response, final FilterChain filterChain)
        ...
        if (!(requestType == CorsFilter.CORSRequestType.SIMPLE || requestType == CorsFilter.CORSRequestType.ACTUAL)) {
            throw new IllegalArgumentException(
                            sm.getString("corsFilter.wrongType2", CorsFilter.CORSRequestType.SIMPLE, CorsFilter.CORSRequestType.ACTUAL));
        }
     ...
     * 
     * @deprecated Not used. Will be removed in Tomcat 8.5.x onwards. All HTTP methods not in {@link #SIMPLE_HTTP_METHODS} are assumed to be
     *             non-simple.
     */
    @Deprecated
    ...
    /**
     * {@link Collection} of media type values for the Content-Type header that will be treated as 'simple'. Note media-type values are compared
     * ignoring parameters and in a case-insensitive manner.
     *
     * @see <a href="http://www.w3.org/TR/cors/#terminology" >http://www.w3.org/TR/cors/#terminology</a>
     */
