...
/**
 * patient_orders_source
 */
public class PatientOrdersSource extends MyBatisSuperModel {
    /**
     * patient_orders_source.id
     */
    private Long id;

    /**
     * 血透病患ID patient_orders_source.fk_patient_id
     */
    private Long fkPatientId;

    /**
     * 病人ID patient_orders_source.pt_id
     */
    private String ptId;

    /**
     * 病患类型(I=住院O=门诊） patient_orders_source.pt_type
     */
    private String ptType;

    /**
     * patient_orders_source.card_no
     */
    private String cardNo;

    /**
     * 就诊次数 patient_orders_source.times
     */
    private String times;

    /**
     * 结账次数 patient_orders_source.receipt_times
     */
    private String receiptTimes;

    /**
     * 本医嘱是否长期医嘱，使用代码，1-长期，0-临时 patient_orders_source.order_flag
     */
    private String orderFlag;

    /**
     * 医嘱流水号 patient_orders_source.order_id
     */
    private String orderId;

    /**
     * 医嘱编号 patient_orders_source.serial_no
     */
    private String serialNo;

    /**
     * 医嘱序号 patient_orders_source.order_no
     */
    private String orderNo;

    /**
     * 医嘱子序号 patient_orders_source.order_sub_no
     */
    private String orderSubNo;

    /**
     * 开医嘱时间 patient_orders_source.enter_time
     */
    private Date enterTime;

    /**
     * 停止时间 patient_orders_source.end_time
     */
    private Date endTime;

    /**
     * 医嘱类别 patient_orders_source.order_class
     */
    private String orderClass;

    /**
     * 项目编码 patient_orders_source.item_code
     */
    private String itemCode;

    /**
     * 项目名称 patient_orders_source.item_name
     */
    private String itemName;

    /**
     * 剂量 patient_orders_source.dosage
     */
    private String dosage;

    /**
     * 剂量单位 patient_orders_source.dosage_unit
     */
    private String dosageUnit;

    /**
     * 规格 patient_orders_source.specifications
     */
    private String specifications;

    /**
     * 领量 patient_orders_source.order_num
     */
    private Double orderNum;

    /**
     * 领量单位 patient_orders_source.num_unit
     */
    private String numUnit;

    /**
     * 单价 patient_orders_source.price
     */
    private Double price;

    /**
     * 计价金额 patient_orders_source.costs
     */
    private Double costs;

    /**
     * 单据号 patient_orders_source.charges_code
     */
    private String chargesCode;

    /**
     * 实收费用 patient_orders_source.charges_atm
     */
    private Double chargesAtm;

    /**
     * patient_orders_source.charges_date
     */
    private Date chargesDate;

    /**
     * 用法编码 patient_orders_source.usage_code
     */
    private String usageCode;

    /**
     * 用法名称 patient_orders_source.usage_name
     */
    private String usageName;

    /**
     * 执行频率编码 patient_orders_source.frequency_code
     */
    private String frequencyCode;

    /**
     * 执行频率描述 patient_orders_source.frequency_desc
     */
    private String frequencyDesc;

    /**
     * 频率次数 patient_orders_source.frequency_count
     */
    private String frequencyCount;

    /**
     * 频率间隔 patient_orders_source.frequency_interval
     */
    private String frequencyInterval;

    /**
     * 频率间隔单位 patient_orders_source.frequency_interval_unit
     */
    private String frequencyIntervalUnit;

    /**
     * 取药标志 patient_orders_source.getdrug_flag
     */
    private String getdrugFlag;

    /**
     * 自备标记 patient_orders_source.provided_indicator
     */
    private String providedIndicator;

    /**
     * 执行时间详细描述 patient_orders_source.exec_time_desc
     */
    private String execTimeDesc;

    /**
     * 开单科室编码 patient_orders_source.dept_code
     */
    private String deptCode;

    /**
     * 开单科室 patient_orders_source.dept_name
     */
    private String deptName;

    /**
     * 开医嘱医生编码 patient_orders_source.doctor_code
     */
    private String doctorCode;

    /**
     * 开医嘱医生 patient_orders_source.doctor_name
     */
    private String doctorName;

    /**
     * patient_orders_source.exec_dept_code
     */
    private String execDeptCode;

    /**
     * 执行科室 patient_orders_source.exec_dept_name
     */
    private String execDeptName;

    /**
     * 校对护士 patient_orders_source.nurse
     */
    private String nurse;

    /**
     * 医嘱状态。已保存:0,已确认:1,已执行:2,已取消:3,已作废:4,已退费:5, 已停止:6 patient_orders_source.order_statues
     */
    private String orderStatues;

    /**
     * 反映本条医嘱计价方面的信息。0-正常计价 1-自带药 2-需手工计价 3-不计价。由护士录入医嘱时，根据医嘱内容确定。 patient_orders_source.billing_attr
     */
    private String billingAttr;

    /**
     * 0-无需皮试，1-续皮试，2-皮试 patient_orders_source.ps_Flag
     */
    private String psFlag;

    /**
     * 0-无需审批，1-需审批 patient_orders_source.yb_flag
     */
    private String ybFlag;

    /**
     * patient_orders_source.pay_flag
     */
    private String payFlag;

    /**
     * 0成药，1草药 patient_orders_source.presc_type
     */
    private String prescType;

    /**
     * 由医保校对接口平台返回 patient_orders_source.uniqueCode
     */
    private String uniquecode;

    /**
     * 药房 patient_orders_source.pharmacy
     */
    private String pharmacy;

    /**
     * 由医保校对平台返回（甲类，乙类，丙类） patient_orders_source.officialLevel
     */
    private String officiallevel;

    /**
     * 表示该医嘱是否已打印医嘱本，0-未打印，1-已打印 patient_orders_source.order_print_indicator
     */
    private String orderPrintIndicator;

    /**
     * patient_orders_source.diag_code
     */
    private String diagCode;

    /**
     * patient_orders_source.diag_name
     */
    private String diagName;

    /**
     * patient_orders_source.del_flag
     */
    private Boolean delFlag;

    /**
     * 创建时间 patient_orders_source.create_time
     */
    private Date createTime;

    /**
     * 创建人 patient_orders_source.create_user_id
     */
    private Long createUserId;

    /**
     * 更新时间 patient_orders_source.update_time
     */
    private Date updateTime;

    /**
     * 更新人 patient_orders_source.update_user_id
     */
    private Long updateUserId;

    /**
     * 租户ID patient_orders_source.fk_tenant_id
     */
