...
public interface ClinicalDiagnosisResultMapper {
	 ...
	 * to the database table clinical_diagnosis_result
	 * 
	 ...
	 * 
	 */
	List<ClinicalDiagnosisResult> selectByPatientId(Long patientId);
	 ...
	 * 
	 */
	ClinicalDiagnosisResult selectByPDId(Long pdId);
